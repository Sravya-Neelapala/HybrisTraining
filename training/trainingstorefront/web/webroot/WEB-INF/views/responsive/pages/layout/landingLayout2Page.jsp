...
<template:page pageTitle="${pageTitle}">
    ...
    <div class="row no-margin">
        ...
        <div class="helloItIsWcmsInfo">
            <cms:pageSlot position="helloItIsWcmsInfo" var="feature">
                        <cms:component component="${feature}" />
            </cms:pageSlot>
        </div>
    </div>
    ...
    <cms:pageSlot position="CustomOffersSlotName" var="feature" element="div" class="span-24 section5 cms_disp-img_slot">
    <cms:component component="${feature}" />
    </cms:pageSlot>
